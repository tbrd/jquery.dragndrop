 ...
 * 23/05/2012
 *
 * Add drag/drop events to an element. When the user drags,
 * the element will follow the cursor until the user releases the left button
 *
 * If a boundary is provided, the element will not move outside of the confines of the boundary
 * By default, the element will not move outside the boundary of 'body'
 *
 * example usage:
 *
